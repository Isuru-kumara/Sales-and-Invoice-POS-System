...
Route::get('invoice/create/{customer_id?}', 'InvoiceController@create')->name('invoice.create');
Route::post('/invoices/{id}/markAsPaid', [InvoiceController::class, 'markAsPaid'])->name('invoice.markAsPaid');
