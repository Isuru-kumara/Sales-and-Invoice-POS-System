...
class UserAgent extends Base
{
    ...
    public static function msedge()
    {
        ...
        $platforms = [
            ...
            '(' . static::iosToken() . ") AppleWebKit/$saf (KHTML, like Gecko) Version/15.0 EdgiOS/$chrv" . self::numberBetween(1000, 1146) . '.' . self::numberBetween(0, 99) . " Mobile/15E148 Safari/$saf",
        ];
