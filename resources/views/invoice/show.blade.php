            ...
            <div class="col-md-12">
                <div class="tile">
                    <section class="invoice">
                        <div class="row mb-4">
                            <div class="col-6">
                                <h2 class="page-header"><i class="fa fa-file"></i> NEW SINGHE SUPPLIERS</h2>
                            </div>
                            <div class="col-6">
                        ...
                        <div class="row invoice-info">
                            <div class="col-4">From
                                <address><strong>New Singhe Suppliers</strong><br>147/A,Wanduragala,<br>Kurunegala<br>
                                Tel: 0716006797 / 0719000930<br>singahasuppliers2018@gmail.com</address>
                            </div>
                            <div class="col-4">To
