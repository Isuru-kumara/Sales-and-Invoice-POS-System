                    ...
                    <div class="tile-body">
                        <form method="POST" action="{{route('customer.store')}}">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input name="nic" class="form-control @error('nic') is-invalid @enderror" type="text" placeholder="Enter Customer's NIC">
                                @error('nic')
                                <span class="invalid-feedback" role="alert">
                                    <strong>{{ $message }}</strong>
                                </span>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea name="vnumber" class="form-control @error('vnumber') is-invalid @enderror"></textarea>
                                @error('vnumber')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
