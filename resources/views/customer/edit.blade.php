                    ...
                    <div class="tile-body">
                        <form class="row" method="POST" action="{{route('customer.update', $customer->id)}}">
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <input value="{{ $customer->nic }}" name="nic" class="form-control @error('nic') is-invalid @enderror" type="text" placeholder="Enter Customer NIC">
                                @error('nic')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group col-md-12">
                                ...
                                <textarea  name="vnumber" class="form-control @error('vnumber') is-invalid @enderror">{{ $customer->vnumber }}</textarea>
                                @error('vnumber')
                                <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
