                            ...
                            @method('PUT')
                             <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input value="{{$additional->product->serial_number}}" name="serial_number" class="form-control @error('serial_number') is-invalid @enderror" type="number" placeholder="Enter Tax Name">
                                    @error('serial_number')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="tile ">
                                <div class="row field_wrapper">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input name="purchase_price" type="price" class="form-control @error('purchase_price') is-invalid @enderror" placeholder="Enter Purchase Price">
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input name="purchase_date" type="date" class="form-control @error('purchase_date') is-invalid @enderror" placeholder="YYYY-MM-DD">
                                        @error('purchase_date')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                    ...
                                    <div class="form-group col-md-6">
                                        ...
                                        <input name="stock_count" class="form-control" type="number" placeholder="Enter Stock Count" value="{{ old('stock_count', isset($product) ? $product->stock_count : 0) }}">
                                        @error('stock_count')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
